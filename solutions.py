...
def is_sweltering():
    ...
    sweltering = int(input("What is the current temperature (in Fahrenheit)? "))
    if sweltering > 90:
        return True
    else:
        return False
...
def is_warm():
    ...
    # write your code for this function below this line.
    # print("Before warm...")
    warm = int(input("What is the current temperature (in Fahrenheit)? "))
    if warm >= 75 and warm <= 87:
        return True
    else:
        return False
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    # print("Before inclement...")
    inclement = input("What is the weather forecast today? ")
    if inclement == "rain" or inclement == "snow" or inclement == "sleet":
        return True
    else:
        return False
...
def is_typical_new_york_summer():
    ...
    """
    # write your code for this function below this line.
    # print("Before nyc summer...")
    typical = is_sweltering()
    summer = is_humid()
    if typical is True and summer is True:
        return True
    else:
        return False
...
def is_cool_and_nice():
    ...
    """
    # write your code for this function below this line.
    # print("Before cool and nice...")
    heat = is_sweltering()
    cool = is_warm()
    nice = is_humid()
    weather = is_inclement()
    if heat is False and cool is False and nice is False and weather is False:
        return True
    else:
        return False
